...
import { FileText, BookOpen, Users, ShieldCheck } from 'lucide-react';
      ...
      <main className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-6">
        <Tabs value={activeTab} onValueChange={setActiveTab}>
          ...
          <TabsContent value="lme">
            <LmeTab medicos={medicos} />
          </TabsContent>

          <TabsContent value="relatorios">
            <RelatoriosTab medicos={medicos} />
          </TabsContent>

          <TabsContent value="medicos">
            <MedicosTab medicos={medicos} setMedicos={setMedicos} />
          </TabsContent>
        </Tabs>
      </main>
